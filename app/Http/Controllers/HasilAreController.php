...
class HasilAreController extends Controller
{
    /**
    ...
    public function index()
    {
        ...
        if(Auth::user()->is_admin == 1){
            return view("/themes/ezone/perkembanganhewan/hasilare", ['anjingres'=>$anjingres]);
        }
        else{
            return view("/themes/ezone/perkembanganhewan/hasilare", ['anjingres'=>$array_tmp]);
        }
    }
