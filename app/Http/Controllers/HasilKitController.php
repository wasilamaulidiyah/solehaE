...
class HasilKitController extends Controller
{
    /**
    ...
    public function index()
    {
        ...
        if(Auth::user()->is_admin == 1){
            return view("/themes/ezone/perkembanganhewan/hasilkitten", ['kucings'=>$kucings]);
        }
        else{
            return view("/themes/ezone/perkembanganhewan/hasilkitten", ['kucings'=>$array_tmp]);
        }
    }
